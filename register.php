...
if(isset($_POST["custom_signup"])) {
    ...
    // Check input errors before inserting in database
                            ...
                            //echo sizeof($display);
                                    ...
                                    {
                                       ?> <p style="background-color:#e20000; color:WHITE; padding:10px 10px 10px 90px;"><strong>Mobile Number Already Exists!</strong></p>
...
?>
                            ...
                            document.getElementById('fname').value = obj.id;
                            </script>
  ...
  foreach($data as $d){
     echo "hey1";
      ...
      echo "hey2";
            ...
            $facebook_details =$_POST['myJson'];
                            echo $facebook_details;
